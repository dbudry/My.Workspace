...
public class ProjectColorRulesTests
{
    ...
    {
        Assert.Equal("Sample Network",
            ProjectColorRules.ResolveLabel("Organization Alpha", "Sample Network", OrgRed, GroupBlue,
    ...
    public void ResolveLabel_returns_org_name_for_GroupThenOrg_when_group_color_missing()
    {
        ...
        Assert.Equal("Organization Alpha",
            ProjectColorRules.ResolveLabel("Organization Alpha", "Sample Network", OrgRed, null,
                ProjectColorSource.GroupThenOrganization));
    }
    ...
    {
        Assert.Null(ProjectColorRules.ResolveLabel("Organization Alpha", "Sample Network", OrgRed, GroupBlue, source));
    }
    ...
    public void ResolveLabel_returns_null_when_no_color_would_be_drawn()
    {
        ...
        Assert.Null(ProjectColorRules.ResolveLabel("Organization Alpha", "Sample Network", null, null,
            ProjectColorSource.GroupThenOrganization));
    }
