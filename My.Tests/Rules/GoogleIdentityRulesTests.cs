...
public class GoogleIdentityRulesTests
{
    ...
    private const string MultiDomains = "example.com, partner.org";
    ...
    public void IsAllowedEmail_multi_domain()
    {
        ...
        Assert.True(GoogleIdentityRules.IsAllowedEmail("b@partner.org", MultiDomains));
    ...
    {
        var parsed = GoogleIdentityRules.ParseAllowedDomains(" @Example.com, partner.org ;foo.io ");
        Assert.Equal(new[] { "example.com", "partner.org", "foo.io" }, parsed);
    }
