...
public class IntranetSearchHelperTests
{
    ...
    {
        var terms = IntranetSearchHelper.ParseQueryTerms("  SampleOrg  Network  ");
        Assert.Equal(["sampleorg", "network"], terms);
    }
    ...
    public void SearchPages_requires_all_terms_and_prefers_title()
    {
        ...
        var hits = IntranetSearchHelper.SearchPages(pages, ["sampleorg", "network"], limit: 10);
