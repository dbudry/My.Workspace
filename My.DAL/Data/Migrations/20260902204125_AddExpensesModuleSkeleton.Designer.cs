...
namespace My.DAL.Data.Migrations
{
    ...
    [Migration("20260902204125_AddExpensesModuleSkeleton")]
    partial class AddExpensesModuleSkeleton
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("My.DAL.Models.AppSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Description = "OrganizationId of Profit Point (the company). Expenses department pickers filter to this org.",
                            Value = ""
                        },
                        new
                        {
            ...
            modelBuilder.Entity("My.DAL.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "10a1b2c3-d4e5-4678-9abc-def012345603",
                            ConcurrencyStamp = "10a1b2c3-d4e5-4678-9abc-def012345603",
                            Description = "Expenses-scoped admin role (module admin).",
                            Name = "Admin:Expenses",
                            NormalizedName = "ADMIN:EXPENSES"
                        });
                });
            ...
            modelBuilder.Entity("My.DAL.Models.TrackedTask", b =>
                {
                    ...
                    b.Property<DateTime?>("GoogleEventUpdatedUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("My.DAL.Models.TrackedTaskCorrectionAudit", b =>
                {
                    b.Property<string>("TrackedTaskCorrectionAuditId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("TrackedTaskCorrectionAuditId");

                    b.HasIndex("TaskId")
                        .IsUnique();

                    b.ToTable("TrackedTaskCorrectionAudits");
                });
